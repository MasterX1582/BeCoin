...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(42543433028000000000);
...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 24 * 60 * 60 / DIFFICULTY_TARGET * 2;
...
const char     CRYPTONOTE_NAME[]                             = "BeCoin";
...
const int      P2P_DEFAULT_PORT                              = 58236;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 58237;
